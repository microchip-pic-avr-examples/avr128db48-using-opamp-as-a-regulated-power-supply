...
pipeline {
	...
	environment {
		...
		GITHUB_URL ='https://github.com/microchip-pic-avr-examples/avr128db48-using-opamp-as-a-regulated-power-supply.git'
		BITBUCKET_URL = 'https://bitbucket.microchip.com/scm/ebe/avr128db48-using-opamp-as-a-regulated-power-supply.git'
